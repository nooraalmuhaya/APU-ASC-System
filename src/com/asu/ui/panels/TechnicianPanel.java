...
public class TechnicianPanel extends JPanel {
    ...
    private void loadSelectedDetails() {
        ...
        if (row < 0) {
            DialogUtils.showError(this,
                    "Go to 'My Appointments' tab and select an appointment first.");
            return;
        }
        String apptId = (String) apptModel.getValueAt(row, 0);
        String[] p    = findAppointmentById(apptId);
        if (p == null) {
            DialogUtils.showError(this, "Appointment not found."); return;
        }
    ...
    private void markCompleted() {
        ...
        if (!DialogUtils.showConfirmation(this,
                "Mark appointment " + apptId + " as Completed?")) return;
        ...
        updateStatusBtn.setEnabled(false);
        loadMyAppointments();
        DialogUtils.showSuccess(this, "Appointment " + apptId + " marked as Completed.");
    }
    ...
    private void handleFeedbackSubmit() {
        ...
        if (comment.isEmpty()) {
            DialogUtils.showError(this, "Please enter your feedback before submitting."); return;
        }
        ...
        DialogUtils.showSuccess(this, "Feedback submitted for appointment " + apptId + ".");
    }
    ...
    private void updateStatusInFile(String apptId, String newStatus) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(f))) {
            ...
            DialogUtils.showError(this, "Read error: " + ex.getMessage()); return;
        }
        try (PrintWriter pw = new PrintWriter(new FileWriter(f, false))) {
            for (String l : lines) pw.println(l);
        } catch (IOException ex) {
            DialogUtils.showError(this, "Write error: " + ex.getMessage());
        }
    }
    ...
    private void writeFeedback(String record) {
        ...
        try (PrintWriter pw = new PrintWriter(new FileWriter(f, true))) {
            ...
            DialogUtils.showError(this, "Could not save feedback: " + ex.getMessage());
        }
    }
}
